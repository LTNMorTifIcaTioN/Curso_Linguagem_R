...
# choose() - número de combinações [n!/(x!(n-x)!)]
# combn() - todos conjuntos gerados pela combinações de certo número de elementos

# Três maneiras para descobrir uma função que faça aquilo que você deseja:
# help.search("termo")
# ??termo
# RSiteSearch("termo")